...
const About = () => {
    return (
        <motion.div initial={{opacity: 0, y: -20}} whileInView={{opacity: 1, y: 0}}  viewport={{once:true}} transition={{duration: 1}} className="mb-10 flex flex-col items-center justify-center lg:mb-0 lg:h-screen lg:flex-row">
